  ...
  return json(request, {
    ...
    coverage: {
      ...
      categories: [
        ...
        { name: "Regression", defined: 19, executions: 57 },
        { name: "Responsive", defined: 6, executions: 12 },
      ],
      browsers: [
        { project: "chromium-desktop", target: "Desktop Chrome", executions: 14 },
        { project: "firefox-desktop", target: "Desktop Firefox", executions: 14 },
        { project: "webkit-desktop", target: "Desktop Safari", executions: 14 },
